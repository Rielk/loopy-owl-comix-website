...
describe('Test Gallery Generator', () => {
	...
	describe('Images', () => {
		it('should add images path', () => {
			expectContainsOnlyObjectsWith(gallery.images, [
				{ path: path.join('kuku', 'kuku-trees.jpg') },
				{ path: path.join('kuku', 'kuku-bubble.jpg') },
				{ path: path.join('popo', 'popo-view.jpg') },
				{ path: 'landscape.jpg' },
			]);
		});
		...
		it('should add images to collection by directory', () => {
			expectContainsOnlyObjectsWith(gallery.images, [
				{ path: path.join('kuku', 'kuku-trees.jpg'), meta: { collections: ['kuku'] } },
				{ path: path.join('kuku', 'kuku-bubble.jpg'), meta: { collections: ['kuku'] } },
				{ path: path.join('popo', 'popo-view.jpg'), meta: { collections: ['popo'] } },
	...
	describe('Existing gallery', () => {
		...
		it('should not override an existing image meta data', async () => {
			const imagePath = path.join('kuku', 'kuku-trees.jpg');
